...
// insertion_sort_decreasing is an efficient algorithm for
// sorting a small number of elements in monotonically desceasing
// order, and it solves the sorting problem.
//
// The input is an array a, which is a sequence of n numbers
// <a_1, a_2, ..., a_n>. The output is the array a, which is a
// permutation <a_1', a_2', ..., a_n'> of the input sequence such
// that a_1' >= a_2' >= ... >= a_n'.
//
// insertion_sort_decreasing uses 1-origin indexing, so the first
// element in the array a is ignored.
//
// The size n is assumed to be 1 less than the number of elements
// in the array a.
